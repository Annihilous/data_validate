...
class CommunicationsControllerTest < ActionController::TestCase
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post :create, communication: { content: @communication.content, title: @communication.title, user_id: @communication.user_id }
    end
  ...
  test "should update communication" do
    patch :update, id: @communication, communication: { content: @communication.content, title: @communication.title, user_id: @communication.user_id }
    assert_redirected_to communication_path(assigns(:communication))
  end
